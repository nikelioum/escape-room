...
<html lang="en">
  <head>
    ...
    <title>Welcome {{ Auth::user()->name }} to Escape room portal</title>
    ...
    <main class="main-container">
      ...
      <div class="main-content container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <a href="/new-appointment" class="btn btn-md btn-info mb-3">New appointment</a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              <h4 class="card-title"><strong>My appointments</strong></h4>
